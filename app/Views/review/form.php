...
<div class="form-group row">
    <div class="col-sm-6 mb-3 mb-sm-0">
        ...
        <div class="show-img-ready">
            ...
            <img src="<?= base_url('upload/review').'/'.$data['image'] ?>" height="100px" width="100px" />
        </div>
        <?php } ?>
    </div>
</div>
...
<div class="form-group row">
    <div class="col-sm-6 mb-3 mb-sm-0">
    <textarea class="form-control ckeditor" name="deskripsi"
            rows="5"><?= $data ? $data['deskripsi'] : '' ?></textarea>
    </div>
</div>
