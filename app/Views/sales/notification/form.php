...
<div class="form-group row">
    <div class="col-sm-6 mb-3 mb-sm-0">
        ...
        <div class="show-img-ready">
            ...
            <img src="<?= base_url('upload/sales/notification/').'/'.$data['image'] ?>" height="150px" width="250px" />
        </div>
        <?php } ?>
...
<div class="row">
    ...
    <div class="col-sm-3 mb-3 mb-sm-0">
        <a href="<?= route_to('admin/sales/notification') ?>" class="btn btn-warning btn-block">
            Back
        </a>
    </div>
</div>
